...
/*
      //MY SQL DBASE CONNECTIVITY 
       ...
       Connection=DriverManager.getConnection("jdbc:mysql://localhost:5053/test");
...
*/
  ...
  // MS ACCESS and MYSQL DBASE CONNECTIVITY
	  ...
	  Class.forName("com.mysql.jdbc.Driver");	
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/ctrust","root","root");
      String sql="";
