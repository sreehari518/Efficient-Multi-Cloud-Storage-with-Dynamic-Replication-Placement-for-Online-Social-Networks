...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 style="color:#FF0000;font-size:18px;"><a href="index.html"><span class="style1">Efficient Multi-Cloud Storage Using Online Dynamic Replication And Placement Algorithms For Online Social Networks</span> </a></h1>
      </div>
  ...
  <tr>
    ...
    <td width="154"><div align="center"><span class="style3">MAC</span></div></td>
